...
def parse_args():
	...
	parser.add_argument("--target-lang", dest="target_lang", type=str, default="si", help="dataset language to train tokenizer on")
...
def main():
	...
	train_texts_si = [ex[args.target_lang] for ex in ds["train"]["translation"]]
